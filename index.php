...
<img src="images/v1.gif" width="100%" height="630px">

<body>
    <div class="container">
            <h3 class="h3"><b>This season</b></h3>
            <div class="row">
                <?php
                    $getNpd = $pd->getSeasonProduct();
                    if($getNpd){
